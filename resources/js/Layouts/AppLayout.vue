                ...
                <div class="max-w-4xl relative mx-auto">
                    <div class="text-center mt-10">
                        ...
                        <p class="mt-4 text-lg">
                            Figure out what's in your food! Have you ever looked
                            at a commercial food product and wondered how to
                            make it? Not a problem! Use this professional
                            technique to recreate a recipe from any nutrition
                            label
                        </p>
