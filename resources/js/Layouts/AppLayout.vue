...
<template>
  <div>
    ...
    <div class="min-h-screen">
          ...
          <Menubar :model="menuItems">
            <template #start>
              <Link :href="route('home')">
                <ApplicationMark class="block h-14 w-auto mr-2" />
              </Link>
            </template>
            <template #item="{ item, props, hasSubmenu, root }">
              <Link
                v-if="item.route && typeof item.items === 'undefined'"
      ...
      <div
        class="max-w-7xl mx-auto overflow-hidden mb-12 p-20 bg-[url('/assets/sub-footer-bg.png')] bg-center relative"
      >
        <div class="max-w-4xl relative mx-auto">
          <div class="text-center mt-10">
            <h1 class="text-4xl">
              <span class="text-main-orange">Recreate</span> a Recipe!
            </h1>
            <p class="mt-4 text-lg">
              Figure out what's in your food! Have you ever looked at a
              commercial food product and wondered how to make it? Not a
              problem! Use this professional technique to recreate a recipe from
              any nutrition label
            </p>
      ...
      <footer>
        ...
        >
          ...
          <p class="text-center text-sm leading-5">
            Recipebox &copy; {{ new Date().getFullYear() }} All rights reserved.
          </p>
        </div>
      </footer>
    </div>
