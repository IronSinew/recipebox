...
const recipeMarkup = ref({
  ...
  image: [props.recipe.hero ? props.recipe.hero : "/assets/no-recipe-img.png"],
});
  ...
  <AppLayout :title="recipe.name">
    ...
    <div class="px-6 lg:px-0 py-12">
      <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
        ...
        <Card
          id="recipe-card-view"
          style="overflow: hidden; position: relative; box-shadow: none"
        >
          <template #content>
            <div v-if="recipe.media.length" class="flex flex-wrap w-full mt-5">
              <div class="w-full">
                <Galleria
            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-4 px-4 py-4">
              <div class="w-full">
              ...
              <div class="w-full lg:col-span-2">
                <h3 class="text-3xl mb-4 mt-4">Instructions:</h3>
