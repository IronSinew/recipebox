  ...
  <AppLayout title="Home">
    <div class="pb-12">
      <div class="container-fluid mx-auto">
        <div
          class="max-h-[900px] overflow-hidden mb-12 p-20 bg-[url('/assets/home-hero-bg.png')] bg-center relative"
        >
          ...
          <div class="h-[900px] max-w-4xl relative mx-auto">
            <div class="text-center mt-10">
              <h1 class="text-4xl">
                <span class="text-main-orange">Discover</span> Every Recipe!
              </h1>
              <h4>
                This is a collection of our favorite, or save-worthy recipes for
                our benefit, and others too.
              </h4>
      ...
      <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
        ...
        <div class="mt-10">
          <div class="mb-5 flex">
            <div class="flex-1">
              <h2>
                <span class="text-main-orange">Recently added</span> recipes
              </h2>
              <p>
        ...
        <div class="mt-20">
          <div class="mb-5 flex">
            <div class="flex-1">
              <h2><span class="text-main-orange">The Severson</span> Blog</h2>
            </div>
            <a
              href="/recipes"
              class="capitalize text-main-orange underline underline-offset-4"
          ...
          <div class="grid sm:grid-cols-1 md:grid-cols-2 gap-10 transition-all">
            <div v-if="!loaded">
              <BlogCard
                v-for="skeleton in 2"
                :key="skeleton"
        ...
        <div class="mt-20">
          <div class="mb-5 flex">
            <div class="flex-1">
              <h2><span class="text-main-orange">Explore</span> categories</h2>
            </div>
            <a
              href="/categories"
              class="capitalize text-main-orange underline underline-offset-4"
