...
<template>
    ...
    <div class="pb-12">
        <div class="container-fluid mx-auto">
            <div
                class="max-h-[900px] overflow-hidden mb-12 sm:py-8 md:py-20 px-6 lg:p-20 bg-[url('/assets/home-hero-bg.png')] bg-center relative"
            >
                ...
                <div class="h-[500px] sm:h-[900px] max-w-4xl relative mx-auto">
                    <div class="text-center sm: mt-4 md:mt-10">
                        ...
                        <h4 class="text-base !text-[#1F1D2B] sm:text-lg">
                            This is a collection of our favorite, or save-worthy
                            recipes for our benefit, and others too.
                        </h4>
    ...
    /> -->
            ...
            <div class="mt-10">
                <div class="mb-5 flex">
                    <div class="flex-1">
                        <h2>
                            <span class="text-main-orange">Recently added</span>
                            recipes
                        </h2>
                        <p>
