        ...
        <form class="mb-5" @submit.prevent="save">
          ...
          <div class="grid grid-cols-3 gap-x-6">
            <div class="my-7">
              ...
              <div
                :class="[form.errors.name ? 'opacity-100' : 'opacity-0']"
            ...
            <div class="my-7">
              ...
              <div
                :class="[form.errors.serving ? 'opacity-100' : 'opacity-0']"
                class="transition-opacity ease-in-out delay-150 duration-300 pt-4 text-sm text-red-500 font-bold"
              >
                {{ form.errors.serving }}
              </div>
          ...
          <div class="grid grid-cols-3 gap-x-6">
            <div class="my-7">
              ...
              />
              <div
                :class="[form.errors.prep_time ? 'opacity-100' : 'opacity-0']"
                class="transition-opacity ease-in-out delay-150 duration-300 pt-4 text-sm text-red-500 font-bold"
              >
            ...
            <div class="my-7">
              ...
              />
              <div
                :class="[form.errors.cook_time ? 'opacity-100' : 'opacity-0']"
                class="transition-opacity ease-in-out delay-150 duration-300 pt-4 text-sm text-red-500 font-bold"
              >
                ...
                >
                  ...
                  <template #footer>
                    <div class="text-right">
                      <Button
                        v-if="image.collection_name !== 'hero'"
            ...
            <div class="grid md:grid-cols-2 gap-x-6">
              <Fieldset legend="Ingredients">
                <div class="h-64">
                  ...
                  <div
                    :class="[
                      form.errors.ingredients ? 'opacity-100' : 'opacity-0',
                    ]"
                    class="transition-opacity ease-in-out delay-150 duration-300 pt-4 text-sm text-red-500 font-bold"
                  >
            ...
            <div class="grid md:grid-cols-2 gap-x-6">
              <Fieldset legend="Instructions">
                <div class="h-64">
                  ...
                  <div
                    :class="[
                      form.errors.instructions ? 'opacity-100' : 'opacity-0',
                    ]"
                    class="transition-opacity ease-in-out delay-150 duration-300 pt-4 text-sm text-red-500 font-bold"
                  >
            ...
            <div class="grid md:grid-cols-2 gap-x-6">
              <Fieldset legend="Description">
                <div class="h-64">
                  ...
                  <div
                    :class="[
                      form.errors.description ? 'opacity-100' : 'opacity-0',
                    ]"
                    class="transition-opacity ease-in-out delay-150 duration-300 pt-4 text-sm text-red-500 font-bold"
                  >
