...
namespace Illuminate\Http {
     ...
     */        class RedirectResponse {
         ...
         * @param string $message
         * @param \App\Enums\BannerTypeEnum|null $bannerType
         * @static 
         */        public static function withBanner($message, $bannerType = \App\Enums\BannerTypeEnum::success)
        {
                        return \Illuminate\Http\RedirectResponse::withBanner($message, $bannerType);
        }
                    /**
         * 
         *
