...
'scout.typesense.model-settings.App\\Models\\Recipe.collection-schema.token_separators','scout.typesense.model-settings.App\\Models\\Recipe.collection-schema.default_sorting_field','scout.typesense.model-settings.App\\Models\\Recipe.search-parameters.query_by','services.postmark.token','services.ses.key',
...
'inertia.history.encrypt','nightwatch.enabled','nightwatch.token','nightwatch.deployment','nightwatch.server',
'nightwatch.capture_exception_source_code','nightwatch.redact_headers','nightwatch.sampling.requests','nightwatch.sampling.commands','nightwatch.sampling.exceptions',
'nightwatch.filtering.ignore_cache_events','nightwatch.filtering.ignore_mail','nightwatch.filtering.ignore_notifications','nightwatch.filtering.ignore_outgoing_requests','nightwatch.filtering.ignore_queries',
'nightwatch.filtering.log_level','nightwatch.ingest.uri','nightwatch.ingest.timeout','nightwatch.ingest.connection_timeout','nightwatch.ingest.event_buffer',
...
'ide-helper.post_migrate','blueprint.namespace','blueprint.models_namespace','blueprint.controllers_namespace','blueprint.components_namespace',
'blueprint.policy_namespace','blueprint.app_path','blueprint.generate_phpdocs','blueprint.use_constraints','blueprint.on_delete',
'blueprint.on_update','blueprint.fake_nullables','blueprint.use_guarded','blueprint.singular_routes','blueprint.property_promotion',
'blueprint.generate_resource_collection_classes','blueprint.generators.controller','blueprint.generators.factory','blueprint.generators.migration','blueprint.generators.model',
'blueprint.generators.route','blueprint.generators.seeder','blueprint.generators.test','blueprint.generators.event','blueprint.generators.form_request',
'blueprint.generators.job','blueprint.generators.mail','blueprint.generators.notification','blueprint.generators.resource','blueprint.generators.view',
'blueprint.generators.inertia_page','blueprint.generators.policy','tinker.commands','tinker.alias','tinker.dont_alias',);
