...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'filesystems.links./var/www/app/public/storage' => 'string',
            ...
            'scout.typesense.model-settings.App\Models\Recipe.collection-schema.fields.0.name' => 'string',
            'scout.typesense.model-settings.App\Models\Recipe.collection-schema.fields.0.type' => 'string',
            'scout.typesense.model-settings.App\Models\Recipe.collection-schema.fields.1.name' => 'string',
            'scout.typesense.model-settings.App\Models\Recipe.collection-schema.fields.1.type' => 'string',
            'scout.typesense.model-settings.App\Models\Recipe.collection-schema.fields.2.name' => 'string',
            'scout.typesense.model-settings.App\Models\Recipe.collection-schema.fields.2.type' => 'string',
            'scout.typesense.model-settings.App\Models\Recipe.collection-schema.token_separators' => 'array',
            'scout.typesense.model-settings.App\Models\Recipe.collection-schema.default_sorting_field' => 'string',
            'scout.typesense.model-settings.App\Models\Recipe.search-parameters.query_by' => 'string',
            ...
            'blueprint.namespace' => 'string',
            'blueprint.models_namespace' => 'string',
            'blueprint.controllers_namespace' => 'string',
            'blueprint.components_namespace' => 'string',
            'blueprint.policy_namespace' => 'string',
            'blueprint.app_path' => 'string',
            'blueprint.generate_phpdocs' => 'boolean',
            'blueprint.use_constraints' => 'boolean',
            'blueprint.on_delete' => 'string',
            'blueprint.on_update' => 'string',
            'blueprint.fake_nullables' => 'boolean',
            'blueprint.use_guarded' => 'boolean',
            'blueprint.singular_routes' => 'boolean',
            'blueprint.property_promotion' => 'boolean',
            'blueprint.generate_resource_collection_classes' => 'boolean',
            'blueprint.generators.controller' => 'string',
            'blueprint.generators.factory' => 'string',
            'blueprint.generators.migration' => 'string',
            'blueprint.generators.model' => 'string',
            'blueprint.generators.route' => 'string',
            'blueprint.generators.seeder' => 'string',
            'blueprint.generators.test' => 'string',
            'blueprint.generators.event' => 'string',
            'blueprint.generators.form_request' => 'string',
            'blueprint.generators.job' => 'string',
            'blueprint.generators.mail' => 'string',
            'blueprint.generators.notification' => 'string',
            'blueprint.generators.resource' => 'string',
            'blueprint.generators.view' => 'string',
            'blueprint.generators.inertia_page' => 'string',
            'blueprint.generators.policy' => 'string',
...
'filesystems.disks.s3.url','filesystems.disks.s3.endpoint','filesystems.disks.s3.use_path_style_endpoint','filesystems.disks.s3.throw','filesystems.links./var/www/app/public/storage',
...
'logging.channels.emergency.path','logging.channels.nightwatch.driver','logging.channels.nightwatch.via','logging.channels.nightwatch.level','mail.default',
...
'scout.typesense.client-settings.retry_interval_seconds','scout.typesense.model-settings.App\\Models\\Recipe.collection-schema.fields.0.name','scout.typesense.model-settings.App\\Models\\Recipe.collection-schema.fields.0.type','scout.typesense.model-settings.App\\Models\\Recipe.collection-schema.fields.1.name','scout.typesense.model-settings.App\\Models\\Recipe.collection-schema.fields.1.type',
'scout.typesense.model-settings.App\\Models\\Recipe.collection-schema.fields.2.name','scout.typesense.model-settings.App\\Models\\Recipe.collection-schema.fields.2.type','scout.typesense.model-settings.App\\Models\\Recipe.collection-schema.token_separators','scout.typesense.model-settings.App\\Models\\Recipe.collection-schema.default_sorting_field','scout.typesense.model-settings.App\\Models\\Recipe.search-parameters.query_by',
...
'session.http_only','session.same_site','session.partitioned','inertia.ssr.enabled','inertia.ssr.url',
'inertia.ssr.ensure_bundle_exists','inertia.ensure_pages_exist','inertia.page_paths','inertia.page_extensions','inertia.testing.ensure_pages_exist',
'inertia.testing.page_paths','inertia.testing.page_extensions','inertia.history.encrypt','nightwatch.enabled','nightwatch.token',
'nightwatch.deployment','nightwatch.server','nightwatch.capture_exception_source_code','nightwatch.redact_headers','nightwatch.sampling.requests',
'nightwatch.sampling.commands','nightwatch.sampling.exceptions','nightwatch.filtering.ignore_cache_events','nightwatch.filtering.ignore_mail','nightwatch.filtering.ignore_notifications',
...
'nightwatch.ingest.connection_timeout','nightwatch.ingest.event_buffer','eloquent-sortable.order_column_name','eloquent-sortable.sort_when_creating','eloquent-sortable.ignore_timestamps',
...
'ide-helper.additional_relation_return_types','ide-helper.enforce_nullable_relationships','ide-helper.post_migrate','blueprint.namespace','blueprint.models_namespace',
'blueprint.controllers_namespace','blueprint.components_namespace','blueprint.policy_namespace','blueprint.app_path','blueprint.generate_phpdocs',
'blueprint.use_constraints','blueprint.on_delete','blueprint.on_update','blueprint.fake_nullables','blueprint.use_guarded',
'blueprint.singular_routes','blueprint.property_promotion','blueprint.generate_resource_collection_classes','blueprint.generators.controller','blueprint.generators.factory',
'blueprint.generators.migration','blueprint.generators.model','blueprint.generators.route','blueprint.generators.seeder','blueprint.generators.test',
'blueprint.generators.event','blueprint.generators.form_request','blueprint.generators.job','blueprint.generators.mail','blueprint.generators.notification',
'blueprint.generators.resource','blueprint.generators.view','blueprint.generators.inertia_page','blueprint.generators.policy','tinker.commands',
...
'two-factor.secret-key','two-factor.recovery-codes','two-factor.regenerate-recovery-codes','profile.show','other-browser-sessions.destroy',
'current-user-photo.destroy','current-user.destroy','sanctum.csrf-cookie','ignition.healthCheck','ignition.executeSolution',
'ignition.updateConfig','home','category.index',
'category.list','category.show','label.index','label.show','recipe.all',
'recipe.show','search.simple','admin.labels.set_order','admin.labels.restore','admin.labels.index',
'admin.labels.store','admin.labels.edit','admin.labels.update','admin.labels.destroy','admin.categories.set_order',
'admin.categories.restore','admin.categories.index','admin.categories.store','admin.categories.edit','admin.categories.update',
'admin.categories.destroy','admin.users.index','admin.users.create','admin.users.store','admin.users.edit',
'admin.users.update','admin.users.destroy','admin.recipes.restore','admin.recipes.images.store','admin.recipes.index',
'admin.recipes.create','admin.recipes.store','admin.recipes.edit','admin.recipes.update','admin.recipes.destroy',
'admin.images.destroy','admin.images.make_hero',);
        registerArgumentsSet('views', 
'app','emails.team-invitation','laravel-exceptions-renderer::components.card','laravel-exceptions-renderer::components.context','laravel-exceptions-renderer::components.editor',
...
'AWS_USE_PATH_STYLE_ENDPOINT','VITE_APP_NAME','SCOUT_DRIVER','TYPESENSE_PORT','TYPESENSE_API_KEY',
'TYPESENSE_HOST','SCOUT_PREFIX','SCOUT_QUEUE',);
