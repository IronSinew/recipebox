...
'filesystems.links./var/www/app/public/storage','fortify.guard','fortify.middleware','fortify.auth_middleware','fortify.passwords',
...
'fortify.redirects.password-reset','fortify.features','jetstream.stack','jetstream.middleware','jetstream.features',
...
'logging.channels.null.handler','logging.channels.emergency.path','logging.channels.nightwatch.driver','logging.channels.nightwatch.via','logging.channels.nightwatch.level',
...
'scout.typesense.client-settings.num_retries','scout.typesense.client-settings.retry_interval_seconds','scout.typesense.model-settings.App\\Models\\Recipe.collection-schema.fields.0.name','scout.typesense.model-settings.App\\Models\\Recipe.collection-schema.fields.0.type','scout.typesense.model-settings.App\\Models\\Recipe.collection-schema.fields.1.name',
'scout.typesense.model-settings.App\\Models\\Recipe.collection-schema.fields.1.type','scout.typesense.model-settings.App\\Models\\Recipe.collection-schema.token_separators','scout.typesense.model-settings.App\\Models\\Recipe.collection-schema.default_sorting_field','scout.typesense.model-settings.App\\Models\\Recipe.search-parameters.query_by','services.postmark.token',
...
'concurrency.default','inertia.ssr.enabled','inertia.ssr.url','inertia.testing.ensure_pages_exist','inertia.testing.page_paths',
'inertia.testing.page_extensions','nightwatch.enabled','nightwatch.token','nightwatch.deployment','nightwatch.server',
...
'nightwatch.ingest.timeout','nightwatch.ingest.connection_timeout','nightwatch.ingest.event_buffer','eloquent-sortable.order_column_name','eloquent-sortable.sort_when_creating',
'eloquent-sortable.ignore_timestamps','flare.key','flare.flare_middleware','flare.flare_middleware.Spatie\\LaravelIgnition\\FlareMiddleware\\AddLogs.maximum_number_of_collected_logs','flare.flare_middleware.Spatie\\LaravelIgnition\\FlareMiddleware\\AddQueries.maximum_number_of_collected_queries',
...
'ide-helper.post_migrate','ide-helper.macroable_traits','blueprint.namespace','blueprint.models_namespace','blueprint.controllers_namespace',
'blueprint.components_namespace','blueprint.policy_namespace','blueprint.app_path','blueprint.generate_phpdocs','blueprint.use_constraints',
'blueprint.on_delete','blueprint.on_update','blueprint.fake_nullables','blueprint.use_guarded','blueprint.singular_routes',
'blueprint.property_promotion','blueprint.generate_resource_collection_classes','blueprint.generators.controller','blueprint.generators.factory','blueprint.generators.migration',
'blueprint.generators.model','blueprint.generators.route','blueprint.generators.seeder','blueprint.generators.test','blueprint.generators.event',
'blueprint.generators.form_request','blueprint.generators.job','blueprint.generators.mail','blueprint.generators.notification','blueprint.generators.resource',
'blueprint.generators.view','blueprint.generators.inertia_page','blueprint.generators.policy','tinker.commands','tinker.alias',
'tinker.dont_alias',);
...
'two-factor.secret-key','two-factor.recovery-codes','profile.show','other-browser-sessions.destroy',
